...
class Painting extends Component {
    ...
    async bid(event){
        ...
        if(this.state.highestBid){
            if(bidprice<this.state.highestBid){
                alert("Bid price must be higher than Highest bid orice!")
            }
        }
        else if(bidprice<this.state.price){
            alert("Bid price must be higher than current Price!")
        }
        // if(bidprice>this.state.highestBid && bidprice>this.state.price)
        if(bidprice>this.state.price){
            if(this.state.highestBid){
                if(bidprice<this.state.highestBid){
                    alert("Bid price must be higher than Highest bid orice!")
                }
                    ...
                    let url ="http://localhost:8099/paintings/postBiddingRequestBuyer";
